...
class CaseDetailPipeline(BasePipeline):
    ...
    def process_item(self):
        try:
            return self.db_mechanism.get_case(self.request, self.case_id)
        except Exception as e:
            logger.error(f"Error in CaseDetailPipeline: {e}")
            return False, f"Error getting case: {e}", None
